...
import EBooks from "../dashboard/Ebook";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/ebooksinglebook/:book_id/:authormain" element={<EbookSingleBook />}/>
        <Route path="/singleaudiobook/:audiobook_id/:authormain" element={<SingleAudioBook />} />
