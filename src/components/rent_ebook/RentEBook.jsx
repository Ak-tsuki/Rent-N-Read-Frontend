...
const RentEBook = ({ _id, bookOwner, name, rent_cost }) => {
  ...
  const rentEBook = (e) => {
    ...
    axios
      .post("http://localhost:90/rentEbook/add", data, config)
      .then((res) => {
        if (res.status === 201) {
  ...
  return (
    <div>
      <div className="form-title row justify-content-center mb-5 rent-heading-container">
        <h2 className="text-center m-0 py-3 rent-heading">Rent EBook</h2>
      </div>
      <Box
        component="form"
        sx={{
